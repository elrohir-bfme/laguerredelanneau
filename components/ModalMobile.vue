        ...
        <div class="mx-auto m-2" v-for="player in map[region].players" :key="player.name">
          ...
          <div v-if="player.mercenaire" class="rounded-lg bg-gray-400 uppercase px-2 py-1 text-xs font-bold mr-3 text-white text-center hover:bg-gray-500">{{updatePlayer(player.name)}}
            <span class="block text-center text-xs font-normal">
              ...
              <img v-if="player.handicap == 1" alt="Handicap" class="w-4 h-4 inline-block" src="~assets/img/pages/index/modal/sangjaune.svg">
              <img v-if="player.handicap == 2" alt="Handicap" class="w-4 h-4 inline-block" src="~assets/img/pages/index/modal/sang.svg">
              <img v-if="player.handicap == 3" alt="Handicap" class="w-4 h-4 inline-block" src="~assets/img/pages/index/modal/sang.svg">
