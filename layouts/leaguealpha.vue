    ...
    <header class="text-white">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-2xl justify-center bg-gray border-orange-500 border-2 border-opacity-75 hover:border-orange-600">
          ...
          <nuxt-link class="p-4 text-orange-500 hover:text-white hover:bg-gray-900" :to="localePath('/league/beta')">{{ $t('league.league') }}</nuxt-link>
          <nuxt-link class="p-4 text-orange-500 hover:text-white hover:bg-gray-900" :to="localePath('/league/beta/matchs')">{{ $t('league.matchs') }}</nuxt-link>
          <nuxt-link class="p-4 text-orange-500 hover:text-white hover:bg-gray-900" :to="localePath('/league/beta/players')">{{ $t('league.players') }}</nuxt-link>
          <nuxt-link class="p-4 text-orange-500 hover:text-white hover:bg-gray-900" :to="localePath('/league/beta/factions')">{{ $t('league.factions') }}</nuxt-link>
          <nuxt-link class="p-4 text-orange-500 hover:text-white hover:bg-gray-900" :to="localePath('/league/beta/maps')">{{ $t('league.maps') }}</nuxt-link>
          ...
          <a rel="noopener noreferrer" style="font-family: 'Albertus'" class="p-4 text-gray-600 hover:text-white hover:bg-gray-900" target="_blank" href="https://discord.gg/aaAH56J">
