        ...
        <div v-if="tour.matchs && tour.matchs.length > 0" class="flex flex-wrap -m-2">
              <div v-for="(match, name) in tour.matchs" :key="match.index" class="p-2 pb-10 m-4 flex-auto border-gray-800 border rounded-lg hover:bg-gray-800 hover:border-gray-900">
                ...
                <div class="flex items-center">
                  <img v-if="match.win == 1" alt="Rohan" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/rohan.png">
                  <img v-else-if="match.win == 2" alt="Elfe" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/elfe.png">
                  <img v-else-if="match.win == 3" alt="Homme" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/gondor.png">
                  <img v-else-if="match.win == 4" alt="Nain" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/nain.png">
                  <img v-else-if="match.win == 5" alt="Mordor" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/mordor.png">
                  <img v-else-if="match.win == 6" alt="Isengard" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/isengard.png">
                  <img v-else-if="match.win == 7" alt="Gobelin" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/gobelin.png">
                  <img v-else alt="Angmar" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-2" src="/img/factions/angmar.png">
                  ...
                  <img v-if="match.lose == 1" alt="Rohan" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/rohan.png">
                  <img v-else-if="match.lose == 2" alt="Elfe" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/elfe.png">
                  <img v-else-if="match.lose == 3" alt="Homme" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/gondor.png">
                  <img v-else-if="match.lose == 4" alt="Nain" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/nain.png">
                  <img v-else-if="match.lose == 5" alt="Mordor" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/mordor.png">
                  <img v-else-if="match.lose == 6" alt="Isengard" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/isengard.png">
                  <img v-else-if="match.lose == 7" alt="Gobelin" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/gobelin.png">
                  <img v-else alt="Angmar" class="w-12 h-12 object-cover object-center flex-shrink-0 rounded-full mr-4 ml-4" src="/img/factions/angmar.png">
              </div>
