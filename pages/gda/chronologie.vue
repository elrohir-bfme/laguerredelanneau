...
<section class="text-gray-600 body-font">
  <div class="container mx-auto">
    <div class="flex flex-col text-center w-full mb-4">
      <h1 class="sm:text-3xl text-3xl font-medium title-font mb-4 text-gray-300">Chronologie de la Guerre de l'Anneau</h1>
      <h2 class="lg:w-2/3 text-center mx-auto leading-relaxed text-2xl">Suivez les évènements et les prises de territoire dans cette lutte incessante !</h2>
      <p class="mx-auto mt-8 mb-4 inline text-2xl text-center text-gray-200 ">Carte Vierge</p>
    </div>
    <div class="flex flex-wrap">
        <img class="mx-auto border-orange-500 border-2" src="https://cdn.discordapp.com/attachments/766584396429262869/796314529490796564/unknown.png">
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
          <p class="text-2xl text-center text-gray-200">Annonce de l'Alliance ! 26 Janvier 2021</p>
        </div><br>
        <div class="mx-auto mt-8 mb-4">
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 8 (8 Mars)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/818468549344624681/unknown.png" alt="">
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 9 (15 Mars)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/821018815927287808/unknown.png" alt="">
        <div class="mx-auto mt-8 mb-4 w-full">
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 12 (06 Avril)</p>
        </div>
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 14 (20 Avril)</p>
        </div>
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 16 (04 Mai)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/839044976897294376/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 17 (11 Mai)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/841557113293504522/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 18 (18 Mai)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/844084552309276703/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 19 (25 Mai)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/846707018537893888/unknown.png" alt="">        
        

        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 20 (1 Juin)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/849246152976891904/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 21 (8 Juin)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/851783101897637978/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 22 (10 Juin)</p>
        </div>
        ...
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 26 (06 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/861845700123164693/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 27 (13 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/864272659561840640/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 28 (20 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/866804991242534921/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 29 (21 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/867343623363625002/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 30 (26 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/869336938648313916/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 31 (28 Juillet)</p>
        </div>
        <img class="mx-auto border-orange-500 border-2"  src="https://cdn.discordapp.com/attachments/766584396429262869/870197776577888256/unknown.png" alt="">        
        
        <div class="mx-auto mt-8 mb-4 w-full">
        <p class="text-2xl text-center text-gray-200">Tour 32 (30 Juillet)</p>
        </div>
