...
<!-- <div class="w-full lg:w-1/2 px-2 mt-6">
          <nuxt-link title="La Bataille pour la Terre du Milieu 2"  to="/tournois/coopetition_bfme2" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-indigo-300 border-2 rounded-xl">
            <NuxtImg
            ...
            <div class="text-center relative z-10 w-full">
              ...
              <br>
              <button
              class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-800 rounded-md dark:bg-gray-700 hover:bg-green-700 dark:hover:bg-gray-700 focus:outline-none focus:bg-green-500 dark:focus:bg-gray-700">
        ...
        <!-- <div class="w-full lg:w-1/2 px-2 mt-6">
          <nuxt-link title="L'Avènement du Roi Sorcier"  to="/tournois/coopetition_rotwk" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-indigo-300 border-2 rounded-xl">
            <NuxtImg
        ...
        <!-- <div class="w-full lg:w-1/2 px-2 mt-6 mb-4">
          <nuxt-link title="L'Avènement du Roi Sorcier"  to="/tournois/fortos_2_02" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-indigo-300 border-2 rounded-xl">
            ...
            />
            <div class="text-center relative z-10 w-full">
              <h2 class="text-3xl text-white font-medium title-font mb-2  group-hover:bg-orange-500 inline p-2 rounded">Tournoi Forteresse</h2>
              <br>
              <br>
              <p class="text-2xl text-orange-300 leading-relaxed group-hover:text-white group-hover:bg-black inline p-2 rounded">Tournoi sur les futures maps forteresses de la GDA</p>
              <br>
              <br>
              <button
              class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-orange-800 rounded-md dark:bg-gray-700 hover:bg-orange-700 dark:hover:bg-gray-700 focus:outline-none focus:bg-orange-500 dark:focus:bg-gray-700">
        ...
        <div class="w-full lg:mt-0 px-2 lg:w-1/2 mb-4">
          <nuxt-link title="La Guerre des apprentis"  to="/tournois/guerre_des_apprentis" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-blue-300 border-2 rounded-xl">
            ...
            />
            <div class="text-center relative z-10 w-full">
              <h2 class="text-3xl text-white font-medium title-font mb-2  group-hover:bg-blue-500 inline p-2 rounded">La Guerre des apprentis</h2>
              <br>
              <br>
              <p class="text-2xl text-blue-300 leading-relaxed group-hover:text-white group-hover:bg-black inline p-2 rounded">Début Novembre 2022</p>
              <br>
              <br>
              <button style="font-family: 'Albertus'" to="/la-campagne-des-gobelins" class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md dark:bg-gray-800 hover:bg-blue-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-blue-500 dark:focus:bg-gray-700">
                <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
                <span class="mx-1">Le tournoi des débutants !</span>
              </button>
            </div>
          </nuxt-link>
          </div>
          ...
          <nuxt-link title="Tournoi mystère 2vs2 ROTWK"  to="/tournois/tournoi_mystere_rotwk_2_02" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-blue-300 border-2 rounded-xl">
            <NuxtImg
              src="tournois/tournoi_rotwk_mystere_2vs2.jpg"
              class="w-full object-cover h-full object-center block opacity-50 group-hover:opacity-100 absolute inset-0 rounded-xl"
              alt="Tournoi mystère 2vs2 ROTWK"
              loading="lazy"
            />
            <div class="text-center relative z-10 w-full">
              <h2 class="text-3xl text-white font-medium title-font mb-2  group-hover:bg-blue-500 inline p-2 rounded">Tournoi mystère 2vs2</h2>
              <br>
              <br>
              <p class="text-2xl text-blue-300 leading-relaxed group-hover:text-white group-hover:bg-black inline p-2 rounded">Organisé par Diablo</p>
              <br>
              <br>
              <button style="font-family: 'Albertus'" to="/tournois/tournoi_mystere_rotwk_2_02" class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md dark:bg-gray-800 hover:bg-blue-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-blue-500 dark:focus:bg-gray-700">
                <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
                <span class="mx-1">Place aux combats !</span>
              </button>
            </div>
          </nuxt-link>
          </div>
          ...
          <div class="w-full mt-5 lg:mt-0 px-2 lg:w-1/2 mb-5">
          <nuxt-link title="Ligue français de l'Avènement du Roi Sorcier"  to="/tournois/tournoi_ainu" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-orange-300 border-2 rounded-xl">
            <NuxtImg
            ...
            <div class="text-center relative z-10 w-full">
              ...
              <br>
              <br>
              <button style="font-family: 'Albertus'" to="/tournois/tournoi_ainu" class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-orange-600 rounded-md dark:bg-gray-800 hover:bg-orange-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-orange-500 dark:focus:bg-gray-700">
                <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
...
<div class="w-full mt-5 lg:mt-0 px-2 lg:w-1/2">
        ...
        <div class="w-full mt-5 lg:mt-0 px-2 lg:w-1/2">
          <nuxt-link title="Loup Garou en Terre du Milieu"  to="/loup-garou" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-purple-300 border-2 rounded-xl">
            ...
            />
            <div class="text-center relative z-10 w-full">
              <h2 class="text-3xl text-white font-medium title-font mb-2 group-hover:text-purple-500 group-hover:bg-white inline p-2 rounded">Loup Garou en Terre du Milieu 🐺</h2>
              <br>
              <br>
              <p class="text-2xl text-purple-300 leading-relaxed group-hover:text-white group-hover:bg-black inline p-2 rounded">40 rôles différents vous attendent dans votre aventure entre amis.</p>
              <br>
              <br>      
              <button style="font-family: 'Albertus'" to="/les_archives_de_numenor/arenedarda" class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-purple-600 rounded-md dark:bg-gray-800 hover:bg-purple-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-purple-500 dark:focus:bg-gray-700">
                <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
        ...
        <!-- <div class="w-full mt-5 lg:mt-0 px-2 lg:w-1/2">
          <nuxt-link title="L'Avènement du Roi Sorcier"  to="/tournois/tournoi_2_02_2vs2" class="group flex flex-wrap w-full bg-gray-800 sm:py-48 py-32 sm:px-10 px-6 relative border-indigo-300 border-2 rounded-xl">
            ...
            <div class="text-center relative z-10 w-full">
              ...
              <br>
              <button
              class="inline-flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-800 rounded-md dark:bg-gray-700 hover:bg-blue-700 dark:hover:bg-gray-700 focus:outline-none focus:bg-blue-500 dark:focus:bg-gray-700">
                <span class="mx-1">{{ $t('bdd_menu_button') }}</span>
              </button>
            </div>
          </nuxt-link>
