  ...
  <div class="bg-gray-900 dark:bg-gray-800 ">
    <div class="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        <h2 class="text-3xl font-extrabold text-gray-200 dark:text-white sm:text-4xl">
            <span class="block">
                La Guerre des Apprentis
            </span>
            <span class="block text-xl text-blue-500 mt-4 mb-4">
                Organisé par Aupif sur le Discord de la Terre du Milieu
            </span>
        </h2>
        ...
        <iframe src="https://challonge.com/fr/84na5psy/module" width="100%" height="600" frameborder="0" scrolling="auto" allowtransparency="true"></iframe>
    </div>
</div>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'twitter:title',
          name: 'twitter:title',
          content: "La Guerre des Apprentis",
        },
        {
        ...
        },
        {
          ...
          name: 'twitter:image',
          content:
            'https://laguerredelanneau.vercel.app/tournois/guerre_des_apprentis.png',
        },
        { hid: 'og:title', name: 'og:title', content: "La Guerre des Apprentis" },
        { hid: 'og:type', name: 'og:type', content: 'website' },
        {
          hid: 'og:url',
          name: 'og:url',
          content: 'https://laguerredelanneau.vercel.app/tournois/guerre_des_apprentis',
        },
        {
          hid: 'og:image',
          name: 'og:image',
        ...
        },
        {
          ...
          name: 'og:description',
          content:
            "Organisé par Aupif sur le discord de la Terre du Milieun",
        },
      ],
    }
    }
