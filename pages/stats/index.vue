<template>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-2xl text-yellow-200">La ligue de JLS</p>
    </div>
    <div class="flex flex-wrap -m-4" v-if="loading">
      <div v-for="card in sortedData" v-bind:key="card.name" class="p-4 lg:w-1/4 md:w-1/2 transform transition duration-500 hover:scale-110 hover:drop-shadow-xl">
