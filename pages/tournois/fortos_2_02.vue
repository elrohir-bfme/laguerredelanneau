  ...
  <div class="bg-gray-900 dark:bg-gray-800 ">
    <div class="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        <h2 class="text-3xl font-extrabold text-gray-200 dark:text-white sm:text-4xl">
            <span class="block">
                Tournoi spécial forteresses ROTWK 2.02
            </span>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-300 dark:text-gray-300">
                               6 matchs, 1 par semaine.
                               Si vous ne trouvez pas d'horaire pour un 3v3 je vous invites à faire un 2v2 sur une forto 2v2
                            </p>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-2 text-base leading-6 text-gray-300 dark:text-gray-300">
                                ...
                                Anneau de pouvoir désactivé <br>
                                Host Neutre <br>
                            </p>
                        </div>
                    </div>
